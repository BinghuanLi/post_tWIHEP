...
// Function: 
// select data flip events according to Regions/Postfix and save/reconstruct only interested branches
...
void Rootplas_Flip_2lss(TString InputDir, TString OutputDir, TString FileName, TString Postfix){
    ...
    TString Output = OutputDir  +"/"+FileName+ "_Flip2lss_"+Postfix+".root";
