...
// Function: 
// select data 2lss events according to Regions/Postfix and save/reconstruct only interested branches
...
void Rootplas_Data_2lss(TString InputDir, TString OutputDir, TString FileName, TString Postfix){
    ...
    TString Output = OutputDir  +"/"+FileName+ "_Data2lss_"+Postfix+".root";
    ...
    for (Long64_t i=0;i<nentries; i++) {
        ...
        passCut =  pass2LCharge && pass2LTightID && (pass2LRegionCut || passTHSelectionCut);
