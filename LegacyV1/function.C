...
double get_rewgtlumi(TString FileName, double rwgt){
    ...
    if(FileName.Contains("Legacy16V1_WJets_v1")) wgt= 29514020./86916455.; //only applyied for samples before 20190930
    if(FileName.Contains("Legacy16V1_WJets_ext")) wgt= 35920 * 61526.7 / 86916455 ; //only applyied for samples before 20190930
    return wgt;
}
double deltaPhi(double phi1, double phi2){
