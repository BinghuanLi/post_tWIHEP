...
def prepareCshJob(shFile,region):
    ...
    print >> subFile, "gcc -v"
    print >> subFile, "pwd"
    command_run = "root -l -b -q "+frameworkDir+executable+"'"+'("'+inputBaseDir+'","'+outputBaseDir+'","'+region+'",true'+")'"
    print >> subFile, command_run 
    command_run = "root -l -b -q "+frameworkDir+executable+"'"+'("'+inputBaseDir+'","'+outputBaseDir+'","'+region+'",false'+")'"
    print >> subFile, command_run 
...
if not os.path.exists("Rootplas/BinData_SigDNN"):
        os.popen("mkdir -p Rootplas/BinData_SigDNN")
if not os.path.exists("Rootplas/BinData_SigTTH"):
        os.popen("mkdir -p Rootplas/BinData_SigTTH")
