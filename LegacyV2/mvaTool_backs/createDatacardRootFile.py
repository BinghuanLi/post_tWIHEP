            ...
            if histoGramPerSample[sample] in nominal.keys():
                if sample!="Fakes": 
                    if use_ctcvcp and ("THQ" in sample or "THW" in sample or "ttH" in sample) :
                        ...
                        nominal_SM[histoGramPerSample[sample]].Add(inFile.Get(mvaName+sample+"_kt_1_kv_1"))
                    else:
                ...
                if sample!="Fakes": 
                    if use_ctcvcp and ("THQ" in sample or "THW" in sample or "ttH" in sample) :
                        ...
                        nominal_SM[histoGramPerSample[sample]]= inFile.Get(mvaName+sample+"_kt_1_kv_1").Clone(histoGramPerSample[sample])
                    else:
