...
Categories=["DNNSubCat2_option1","SVACat2l","SVACat3j"]
varPerCat={
"SubCat2l":["Bin2l"],
"SVACat2l":["SVABin2l","Hj_tagger"],
"SVACat3j":["SVABin2l","Hj_tagger"],
"DNNCat":["DNN_maxval"],
...
for year in years:
    version = "ttH_2lss_0tau_fixjer_22Jan"
    inputDir = "/publicfs/cms/data/TopQuark/cms13TeV/Binghuan/ttH2019/condorStuff/mvaTool_LegacyAll_SVATrig_20200122/Output_%i_GT5"%year
