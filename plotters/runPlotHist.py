...
dirName = "/publicfs/cms/data/TopQuark/cms13TeV/Binghuan/ttH2019/condorStuff/rootplasDNN_20190321_loose/Rootplas/Output/"

for category in Categories:
    for var in varPerCat[category]:
        print ( "plot var: "+var+ " in cat: "+ category)
        for reg in regPerCat[category]:
            command_run = "python plotHists.py -r "+reg+" -p "+var+" -c "+category+" -d "+dirName 
            print(command_run) 
