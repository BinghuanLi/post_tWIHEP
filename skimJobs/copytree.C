...
void copytree(TString InputDir, TString OutputDir, TString inputName, TString outputName, TString inputFix, TString outputFix, Int_t HiggsFilter= 0){
 
    TString Input = InputDir + "/merged"+inputName + "_"+inputFix+".root";
    TString Output = OutputDir  +"/merged"+outputName+ "_"+outputFix+".root";
