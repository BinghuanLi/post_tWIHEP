...
"DNNSubCat3_option1":["SigRegion","ttWctrl"],
"DNNSubCat3_option2":["SigRegion","ttWctrl"],
"DNNSubCat3_option3":["SigRegion","ttWctrl"],
"DNNSubCat4_option1":["SigRegion","ttWctrl"],
"DNNSubCat4_option2":["SigRegion","ttWctrl"],
"DNNSubCat4_option3":["SigRegion","ttWctrl"],
}
subCats={
...
systs = [
"PU","CMS_ttHl17_trigger","CMS_ttHl16_lepEff_elloose","CMS_ttHl16_lepEff_eltight","CMS_ttHl16_lepEff_muloose","CMS_ttHl16_lepEff_mutight","CMS_ttHl17_btag_HFStats1","CMS_ttHl17_btag_HFStats2","CMS_ttHl16_btag_cErr1","CMS_ttHl16_btag_cErr2","bWeight_jes","CMS_ttHl16_btag_LF","CMS_ttHl16_btag_HF","CMS_ttHl_thu_shape_ttH","CMS_ttHl_thu_shape_ttW","CMS_ttHl_thu_shape_ttZ","CMS_ttHl17_btag_LFStats1","CMS_ttHl17_btag_LFStats2",
"CMS_ttHl16_FRm_norm","CMS_ttHl16_FRm_pt","CMS_ttHl16_FRm_be","CMS_ttHl16_FRe_norm","CMS_ttHl16_FRe_pt","CMS_ttHl16_FRe_be","CMS_ttHl17_Clos_e_shape","CMS_ttHl17_Clos_m_shape","CMS_ttHl17_Clos_e_norm","CMS_ttHl17_Clos_e_bt_norm","CMS_ttHl17_Clos_m_norm","CMS_ttHl17_Clos_m_bt_norm",
"ChargeMis",
]
...
def makeDatacard(mvaName,regions,channeltr,savePostfix=""):
    for region in regions:
        ...
        outFile = TFile(outDir+"ttH_{0}_{1}{2}.root".format(saveName,channeltr,savePostfix),"RECREATE")
        ...
        for sample in samples:
            ...
            if histoGramPerSample[sample] in nominal.keys():
                ...
                for sys in systs:
                    ...
                    if sample == "Flips" and  "ChargeMis" not in sys : continue
                    if sample != "Fakes" and sample != "Flips" and (("Clos" in sys or "_FR" in sys) or ("ChargeMis" in sys)): continue
...
#    for postName in ["bin1000_"]:
    ...
    for postName in [""]:
        ...
        for channel in channels:
            #makeDatacard(mvaNameDef+postName,regions,channel,"_"+postName[:-1])
